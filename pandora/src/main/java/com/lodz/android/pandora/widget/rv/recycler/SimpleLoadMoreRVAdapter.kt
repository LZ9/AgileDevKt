...
abstract class SimpleLoadMoreRVAdapter<T>(context: Context) : BaseLoadMoreRVAdapter<T>(context) {
    ...
    /** 完成加载提示语 */
    private var mFinishText = context.getString(R.string.pandora_load_finish_tips)
    /** 完成加载提示语大小 */
    ...
    /** 正在加载提示语 */
    private var mLoadingMoreText = context.getString(R.string.pandora_loading_more_tips)
    /** 正在加载提示语大小 */
    ...
    /** 加载失败提示语 */
    private var mLoadFailText = context.getString(R.string.pandora_load_fail_tips)
    /** 加载失败提示语大小 */
