 ...
 */
abstract class SimpleLoadMoreDataRvAdapter<T>(context: Context) : BaseLoadMoreDataRvAdapter<T>(context) {
    ...
    override fun getItemViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder =
        DataViewHolder(getLayoutView(parent, getItemLayoutId()))

    @LayoutRes
    abstract fun getItemLayoutId(): Int

    override fun showLoadFinish(holder: DataViewHolder) {
    ...
    override fun showLoadFail(holder: DataViewHolder) {
        if (isPdrGridLayoutManager) {
            val layoutParams = holder.itemView.layoutParams
            layoutParams.width = context.getScreenWidth()
        }
    ...
    override fun showLoadingMore(holder: DataViewHolder) {
        if (isPdrGridLayoutManager) {
            val layoutParams = holder.itemView.layoutParams
            layoutParams.width = context.getScreenWidth()
        }
