...
class PickerManager {
    ...
    companion object {
        ...
        /** 选取手机相册图片 */
        const val PICK_PHONE_ALBUM = 0
        /** 选取手机视频 */
        const val PICK_PHONE_VIDEO = 1
        /** 选取手机音频 */
        const val PICK_PHONE_AUDIO = 2
        /** 选取指定后缀文件 */
        const val PICK_PHONE_SUFFIX = 3
        /** 选取指定的任意类型 */
        const val PICK_ANY = 4
        /** 选取指定的文件 */
        const val PICK_FILE = 5
        /** 选取指定的Uri */
        const val PICK_URI = 6
        /** 选取指定的资源id */
        const val PICK_RES_ID = 7
        /** 选取指定的url */
        const val PICK_IMAGE_URL = 8
