 ...
 * @date 2022/7/25
 */
class SwipeRightHorizontal(menuView: View) : SwipeHorizontal(RIGHT_DIRECTION, menuView) {
    ...
    override fun isClickOnContentView(contentViewWidth: Int, x: Float): Boolean = x < (contentViewWidth - getMenuWidth())
}