...
object ReflectUtils {
    ...
    fun getObject(c: Class<*>, paramClassTypes: Array<Class<*>>, params: Array<Any>): Any? {
        try {
    ...
    fun executeFunction(c: Class<*>, obj: Any, functionName: String, paramClassTypes: Array<Class<*>>, params: Array<Any>): Any? {
        try {
            val method = c.getDeclaredMethod(functionName, *paramClassTypes)// 方法名和参数类型
    ...
    fun getFieldValue(c: Class<*>, obj: Any, typeName: String): Any? {
        try {
    ...
    fun setFieldValue(c: Class<*>, obj: Any, typeName: String, value: Any): Boolean {
        try {
            val field = c.getDeclaredField(typeName)
            field.isAccessible = true
            field.set(obj, value)
