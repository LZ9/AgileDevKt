...
class SharedPreferencesUtils private constructor() {
    ...
    fun putString(key: String, value: String) {
        mContext?.getSharedPreferences(mName, mMode)?.edit {
    ...
    fun getString(key: String, defValue: String): String = catch(defValue) {
        mContext?.getSharedPreferences(mName, mMode)?.getString(key, defValue) ?: defValue
    }
    ...
    fun getBoolean(key: String, defValue: Boolean): Boolean = catch(defValue) {
        mContext?.getSharedPreferences(mName, mMode)?.getBoolean(key, defValue) ?: defValue
    }
    ...
    fun getFloat(key: String, defValue: Float): Float = catch(defValue) {
        mContext?.getSharedPreferences(mName, mMode)?.getFloat(key, defValue) ?: defValue
    }
    ...
    fun getInt(key: String, defValue: Int): Int = catch(defValue) {
        mContext?.getSharedPreferences(mName, mMode)?.getInt(key, defValue) ?: defValue
    }
    ...
    fun getLong(key: String, defValue: Long): Long = catch(defValue) {
        mContext?.getSharedPreferences(mName, mMode)?.getLong(key, defValue) ?: defValue
    }
    ...
    fun getStringSet(key: String, defValue: Set<String>): Set<String> = catch(defValue) {
        mContext?.getSharedPreferences(mName, mMode)?.getStringSet(key, defValue) ?: defValue
    }
    ...
    fun getAll(): Map<String, *>? = catch(null) {
        mContext?.getSharedPreferences(mName, mMode)?.all
    }
