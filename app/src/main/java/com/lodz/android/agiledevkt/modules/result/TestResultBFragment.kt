 ...
 * @date 2022/4/11
 */
class TestResultBFragment : LazyFragment() {
    ...
    companion object {
        ...
        fun newInstance(content: String): TestResultBFragment {
            val fragment = TestResultBFragment()
            val bundle = Bundle()
    ...
    override fun setListeners(view: View) {
        ...
        mBinding.resultBtn.setOnClickListener {
            ...
            val bundle = Bundle()
            bundle.putString(TestResultBFragment::class.java.name, str)
            setFragmentResult(TestResultBFragment::class.java.name, bundle)
            toastShort("发送给 TestResultAFragment")
        }

        parentFragmentManager.setFragmentResultListener(TestResultAFragment::class.java.name, viewLifecycleOwner) { requestKey, result ->
            val str = result.getString(TestResultAFragment::class.java.name, "null")
